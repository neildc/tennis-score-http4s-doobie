...
UPDATE Score SET p1Score = 10 WHERE id = 2;

INSERT INTO Score DEFAULT VALUES;
UPDATE Score SET p1Score = 10, p2Score = 20 WHERE id = 3;

INSERT INTO Score DEFAULT VALUES;
UPDATE Score SET p1Score = 2, playerThatWon = 3 WHERE id = 4;

INSERT INTO Score DEFAULT VALUES;
UPDATE Score SET playerThatWon=2, isDeuce = true WHERE id = 5;

...
class ScoreControllerSpec {
  // private val repository = stub[ScoreRepository]

  // private val controller = new ScoreController(repository).routes

  // "ScoreController" should {
  //   "create a score" in {
  //     val id = 1
  ...
  //   controller.orNotFound(request).unsafeRunSync()
  // }
}
